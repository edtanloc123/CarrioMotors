...
<head>
    ...
    <script src="https://kit.fontawesome.com/84a7e23d8a.js" crossorigin="anonymous"></script>
</head>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="{{ url('/admin/login/logout') }}" class="btn btn-primary py-md-3 px-md-5 mt-2">LOG OUT &nbsp; <i class="fa-solid fa-right-from-bracket"></i></a>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">CARRIO MOTORS</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/management/photo') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Photo Listing</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/management/data') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Car Listing</p>
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('management/') }}/jsgrid.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>jsGrid</p>
                                    </a>
                                </li>
