        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <a class="text-body pl-3" href="{{ url('/admin/login/index') }}">
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="{{ url('/admin/management/data') }}" class="nav-link " >Management</a>
                        </div>
                        <div class="nav-item dropdown">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="{{ url('/admin/action/addnewcar') }}" style="text-decoration: none;">
                            <h4 class="text-uppercase mb-3">ADD NEW CAR</h4>
                        </a>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item active d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="#listcar" style="text-decoration: none;">
                            <h4 class="text-uppercase mb-3">DELETE CARS</h4>
                        </a>
                        <p class="m-0">Kasd dolor no lorem nonumy sit labore tempor at justo rebum rebum stet, justo
                            elitr dolor amet sit sea sed</p>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="#listcar" style="text-decoration: none;">
                            <h4 class="text-uppercase mb-3">EDIT CARS</h4>
                        </a>
                        <p class="m-0">Kasd dolor no lorem nonumy sit labore tempor at justo rebum rebum stet, justo
                            elitr dolor amet sit sea sed</p>
                    </div>
                ...
                <div class="container-fluid py-5">
                    <div class="container pt-5 pb-3">
                        <h1 id="listcar" class="display-4 text-uppercase text-center mb-5">LIST CARS</h1>
                        <div class="row">
                            @foreach ($otoname as $otoname)
                                <div class="col-lg-4 col-md-6 mb-2">
                                    <div class="rent-item mb-4">
                                        <img class="img-fluid mb-4"
                                            src="{{ asset('user') }}/images/{{ $otoname->photo }}" alt="">
                                        ...
                                        <a class="btn btn-primary px-3"
                                            href="{{ url('/admin/carbooking/index/' . $otoname->id) }}">{{ $otoname->price }}$</a><br>
                                        <br>
                                        <a class="btn btn-primary px-3"
                                            href="{{ url('/admin/action/savedeletecar/' . $otoname->id) }}"
                                            onclick="return confirm('Are u sure')">Delete Car</a>
                                        <a class="btn btn-primary px-3"
                                            href="{{ url('/admin/action/editcar/' . $otoname->id) }}">Edit Car</a>
                                    </div>
                                </div>
                            @endforeach
