            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <a href="#addnewcar" style="text-decoration: none;">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 id="addnewcar" class="card-title">ADD NEW CARS</h3>
                    </div>


                    <form method="POST" action="{{ url('/admin/action/saveaddnewcar') }}">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="fuelcapacity">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Segmentid</label>
                                <input type="text" class="form-control" name="segmentid">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Carlineid</label>
                                <input type="text" class="form-control" name="carlineid">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Showroomid</label>
                                <input type="text" class="form-control" name="showroomid">
                            </div>
                            <div class="form-group">
