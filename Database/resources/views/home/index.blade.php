...
@section('content')
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('user') }}/images/carousel-1.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Rent A Car</h4>
                            <h1 class="display-1 text-white mb-md-4">Best place to sell cars</h1>
                            <a href="{{ url('/carlisting/index') }}" class="btn btn-primary py-md-3 px-md-5 mt-2">Reserve
                                Now</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('user') }}/images/carousel-2.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Rent A Car</h4>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Welcome To <span class="text-primary">CARRIO MOTORS</span>
            </h1>
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <img class="w-75 mb-4" src="{{ asset('user') }}/images/about.png" alt="">
                ...
                @foreach ($oto as $oto)
                    <div class="col-lg-4 col-md-6 mb-2">
                        <div class="rent-item mb-4">
                            <a href="{{ url('/details/index/' . $oto->id . '#detailsne') }}"> <img class="img-fluid mb-4"
                                    src="{{ asset('user') }}/images/{{ $oto->photo }}" height="300" width="300"
                                    alt=""> </a>
                            <h4 class="text-uppercase mb-4">{{ $oto->name }}</h4>
                            ...
                            <a class="btn btn-primary px-3" href="{{ url('/details/index/' . $oto->id.'#detailsne') }}">DETAILS</a>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="container py-5">
            <div class="bg-banner py-5 px-4 text-center">
                <div class="py-5">
                    ...
                    <a class="btn btn-primary mt-2 py-3 px-5" href="{{ url('/register/index') }}">Register Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{ asset('user') }}/images/team-1.jpg" alt="">
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{ asset('user') }}/images/team-2.jpg" alt="">
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">Full Name</h4>
                        <p class="m-0">Designation</p>
                        <div
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{ asset('user') }}/images/team-3.jpg" alt="">
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">Full Name</h4>
                        <p class="m-0">Designation</p>
                        <div
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{ asset('user') }}/images/team-4.jpg" alt="">
                    <div class="position-relative py-4">
                        <h4 class="text-uppercase">Full Name</h4>
                        <p class="m-0">Designation</p>
                        <div
                ...
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-secondary d-flex align-items-center justify-content-between"
                        ...
                        <img class="img-fluid flex-shrink-0 ml-n5 w-50 mr-4"
                            src="{{ asset('user') }}/images/banner-left.png" alt="">
                ...
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-dark d-flex align-items-center justify-content-between" style="height: 350px;">
                        ...
                        <img class="img-fluid flex-shrink-0 mr-n5 w-50 ml-4"
                            src="{{ asset('user') }}/images/banner-right.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('user') }}/images/testimonial-1.jpg" alt="">
                ...
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('user') }}/images/testimonial-2.jpg" alt="">
                        <h1 class="display-2 text-white m-0 fa fa-quote-right"></h1>
                    </div>
                    <h4 class="text-uppercase mb-2">Client Name</h4>
                    <i class="mb-2">Profession</i>
                ...
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('user') }}/images/testimonial-3.jpg" alt="">
                        <h1 class="display-2 text-white m-0 fa fa-quote-right"></h1>
                    </div>
                    <h4 class="text-uppercase mb-2">Client Name</h4>
                    <i class="mb-2">Profession</i>
                ...
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('user') }}/images/testimonial-4.jpg" alt="">
                        <h1 class="display-2 text-white m-0 fa fa-quote-right"></h1>
                    </div>
                    <h4 class="text-uppercase mb-2">Client Name</h4>
                    <i class="mb-2">Profession</i>
